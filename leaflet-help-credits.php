...
<div class="wrap">
	...
	<ul>
		...
		<li>- <a href="http://www.mapsmarker.com/customers" target="_blank">mapsmarker.com/customers</a> (<?php _e('support for pro users','lmm'); ?>)</li>
	</ul>
	...
	<ul>
		...
		<li>- MiniMap plugin by Norkart, <a href="https://github.com/Norkart/Leaflet-MiniMap" target="_blank">https://github.com/Norkart/Leaflet-MiniMap</a></li>
	</ul>
